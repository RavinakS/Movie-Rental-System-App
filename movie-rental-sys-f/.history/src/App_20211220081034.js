      ...
      {/* <nav class="navbar navbar-light bg-light">
        ...
        <nav class="navbar navbar-light bg-light">
          <form class="form-inline">
            <a class="nav-item nav-link active" href='/' style={{'margin-right': '10px'}} >Home</a>
            <a to={'/logout'} style={{'margin-right': '10px'}} >Logout</a>
            <a to={'/profile'} style={{'margin-right': '10px'}} >Profile</a>
          </form>
        </nav>
        <Routes>
