      ...
      {/* <nav class="navbar navbar-light bg-light">
        ...
        <nav class="navbar navbar-light bg-light">
          <form class="form-inline">
            <Link to={'/'} style={{'margin-right': '460px', flex-direction: 'row'}} >Home</Link>
            <Link to={'/logout'} style={{'margin-right': '460px'}} >Logout</Link>
            <Link to={'/profile'} style={{'margin-right': '460px'}} >Profile</Link>
          </form>
        </nav>
        <Routes>
