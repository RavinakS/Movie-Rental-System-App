                        ...
                        <div className="col-md-3" key={movie._id}>
                            <div className ="card">
                                ...
                                <div className="card-body">
                                    <p className="genre">Email: {user.genre}</p>
                                    <p className ="Available rents">Rents: {user.avalCD}</p>
                                    <button className="btn btn-primary" onClick={() => {navigate('/users/update-user')}}>Update</button>
                                    <button className="btn btn-primary" onClick={() => {handleClick(user.name)}} >Delete</button>
                                    <Link to={{pathname: `${'/rent-details'}?name=${user.name}`}}>
