        ...
        <>
            <header>
                ...
                <div className="container" style={{ display: "flex", justifyContent: 'flex-end'}}>
                    <button className="btn btn-primary" id="admin" style={{'margin-right': '16px'}} onClick={() => {navigate('/movies/add-movie')}}>Add Movie</button>
                    <button className="btn btn-primary" id="admin" style={{'margin-right: '16px'}} onClick={() => {navigate('/movies/add-movie')}}>Users</button>   
                </div>
            </header>
