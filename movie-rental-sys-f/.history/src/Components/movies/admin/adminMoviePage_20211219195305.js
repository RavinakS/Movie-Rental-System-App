        ...
        <>
            <header>
                ...
                <div className="container">
                    <button 
                        className="btn btn-primary" id="admin" style={{'margin-right': '460px'}} onClick={() => {navigate('/users')}}>Users</button>  
                    <input type="text" id="search" style={{'margin-right': '365px'}} placeholder="Search...." onChange={event => {setSearchTerm(event.target.value)}} /> 
