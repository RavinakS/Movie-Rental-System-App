        ...
        <>
            <header>
                ...
                <div className="container" style={{ display: "flex", justifyContent: 'flex-end'}}>
                    <button className="btn btn-primary" style={{ marginLeft: "auto" }} md={{ span: 2, offset: 10 }} onClick={() => {navigate('/movies/add-movie')}}>Add Movie</button>
                    <button className="btn btn-primary" style={{ marginRight: "auto" }} md={{ span: 2, offset: 0 }} onClick={() => {navigate('/movies/add-movie')}}>Users</button>   
                </div>
            </header>
