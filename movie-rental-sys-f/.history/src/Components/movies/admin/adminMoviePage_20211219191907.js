        ...
        <>
            <header>
                ...
                <div className="container">
                    <button className="btn btn-primary" id="admin" style={{'margin-right': '500px'}} onClick={() => {navigate('/users')}}>Users</button>  
                    <input type="text" id="search" style={{'margin-right': '370px'}} placeholder="Search...." /> 
