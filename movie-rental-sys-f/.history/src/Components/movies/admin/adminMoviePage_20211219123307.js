        ...
        <>
            <header>
                ...
                <div className="container" style={{justifyContent: 'flex-end'}}>
                    <button className="btn btn-primary" id="admin" style={{display: "flex"}} onClick={() => {navigate('/movies/add-movie')}}>Add Movie</button>
                    <button className="btn btn-primary" id="admin" style={{display: "flex"}} onClick={() => {navigate('/movies/add-movie')}}>Users</button>   
                </div>
            </header>
