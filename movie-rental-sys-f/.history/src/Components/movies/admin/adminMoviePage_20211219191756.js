        ...
        <>
            <header>
                ...
                <div className="container">
                    <button className="btn btn-primary" id="admin" style={{'margin-right': '10px'}} onClick={() => {navigate('/users')}}>Users</button>  
                    <input type="text" id="search" style={{'margin-right': '10px'}} placeholder="Search...." /> 
