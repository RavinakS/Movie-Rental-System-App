        ...
        <>
            <header>
                ...
                <div className="container" style={{ display: "flex", justifyContent: 'flex-end'}}>
                    <button className="btn btn-primary" id="admin" style={{display: "flex", 'margin-right': '1120px'}} onClick={() => {navigate('/users')}}>Users</button>  
                    <input type="text" id="search" style={{display: "flex", 'margin-right': '110px'}} placeholder="Search...." /> 
                    <button className="btn btn-primary" id="admin" style={{display: "flex", 'margin-right': '5px'}} onClick={() => {navigate('/movies/add-movie')}}>Add Movie</button>
                </div>
            </header>
