...
export default function AdminMoviepage(){
    ...
    let rents = (m_name) => {
        // console.log("Movie name is: ");
        // axios.get(`/rents-details/${m_name}`)
        // .then((res)=>{
            navigate('/rent-details', { state: m_name });
        // })
        // .catch((err)=>{
        //     console.log(err);
        // })
                        ...
                        <div className="col-md-3" key={movie._id}>
                            <div className ="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to={{pathname: `${'/rent-details'}?name=${m}`}}>
                                        <button className="btn btn-primary" onClick={() => {rents(movie.name)}}>Rent Details</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
