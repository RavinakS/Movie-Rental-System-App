                            ...
                            <div className="col-md-3" key={movie._id}>
                                <div className ="card">
                                    <div className="card-body">
                                        <p className="name">User Name: {movie.user_id.name}</p>
                                        <p className="email">Email: {movie.email}</p>
                                        <p className ="role">Role: {movie.role}</p>
                                        <p className ="rents">Total rents: {movie.rents}</p>
                                    </div>
                                </div>
                            </div>
                        )
