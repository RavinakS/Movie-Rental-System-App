    ...
    return (
        <div className="App">
            <div className="signup">
                ...
                <input type="text" name = "releasDate" value = {user.email} placeholder="Genre" onChange = { handleChange }></input>
                <input type="password" name = "password" value = {user.password} placeholder="rents" onChange = { handleChange }></input>
