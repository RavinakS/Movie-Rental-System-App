    ...
    return (
        <div className="App">
            <div className="signup">
                ...
                <input type="text" name = "genre" value = {movie.email} placeholder="Genre" onChange = { handleChange }></input>
                <input type="text" name = "releasDate" value = {movie.email} placeholder="Release Date" onChange = { handleChange }></input>
                <input type="number" name = "avalCD" value = {movie.password} placeholder="rents" onChange = { handleChange }></input>
