        ...
        <>
            <header>
                ...
                <div className="container" style={{ display: "flex", justifyContent: 'flex-end'}}>
                    <button className="btn btn-primary" style={{background:"light-green", cursor:"pointer"}} onClick={() => {navigate('/movies/add-movie')}}>Add Movie</button>
                    <button className="btn btn-primary" onClick={() => {navigate('/movies/add-movie')}}>Users</button>   
                </div>
            </header>
