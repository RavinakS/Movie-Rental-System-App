                            ...
                            <div className="col-md-3" key={data._id}>
                                <div className ="card">
                                    <div className="card-header text-center card-header-color" >
                                        <h5 className="data-title" >{datap.user_id.name}</h5>
                                    </div>
                                    <div className="card-body">
                                        <p className="email">Email: {data.user_id.email}</p>
                                        <p className ="role">Role: {data.user_id.role}</p>
                                        <p className ="rents">Total rents: {data.user_id.rent}</p>
                                    </div>
                                </div>
                            </div>
                        )
