            ...
            <div className="container">
                ...
                {userDetails.map((data) =>{
                    ...
                    if(data === "no_user"){
                        ...
                        if(!check){
                            return (
                                <div className="col-md-3" key={[0]._id}>
                                    <div className ="card">
                                        <div className="card-header text-center card-header-color" >
                                            <h5 className="data-title" >{[0].name}</h5>
                                        </div>
                                        <div className="card-body">
                                            <p className="email">Email: {[0].email}</p>
                                            <p className ="role">Role: {[0].role}</p>
                                            <p className ="rents">Total rents: {[0].rent}</p>
                                        </div>
                                    </div>
                                </div>
                            )
