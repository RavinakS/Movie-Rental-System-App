            ...
            <div className="container">
                ...
                {userDetails.map((data) =>{
                    if(data === "no_user"){
                        ...
                        return(
                            <div className="col-md-3" key={data[0][0]._id}>
                                <div className ="card">
                                    <div className="card-header text-center card-header-color" >
                                        <h5 className="data-title" >{data[0][0].user_id.name}</h5>
                                    </div>
                                    <div className="card-body">
                                        <p className="email">Email: {data[0][0].user_id.email}</p>
                                        <p className ="role">Role: {data[0][0].user_id.role}</p>
                                        <p className ="rents">Total rents: {data[0][0].user_id.rent}</p>
                                    </div>
                                </div>
                            </div>
                        )
