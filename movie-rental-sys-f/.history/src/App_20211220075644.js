      ...
      {/* <nav class="navbar navbar-light bg-light">
        ...
        <nav class="navbar navbar-light bg-light">
          <form class="form-inline">
            <button to={'/'} style={{'margin-right': '10px'}} >Home</button>
            <button to={'/logout'} style={{'margin-right': '10px'}} >Logout</button>
            <button to={'/profile'} style={{'margin-right': '10px'}} >Profile</button>
          </form>
        </nav>
        <Routes>
